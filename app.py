...
music_recommender = MusicRecommender(gemini_model=mood_analyzer.model)
    ...
    if not st.session_state.analysis_done:
        if prompt := st.chat_input("How are you feeling today?"):
            ...
            try:
                ...
                # Use the mood_analyzer's model to generate a response
                ai_response = mood_analyzer.model.generate_content(chat_prompt)
